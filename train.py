...
from config.config import POLICY_CONFIG, TASK_CONFIG, TRAIN_CONFIG, USE_DEPTH_ANYTHING
...
parser.add_argument('--task', type=str, default="pick_bear_200_tcp_process_step1_test") # open_lid, open_fridge, open_drawer, pick_place_pot
    ...
    for epoch in tqdm(range(train_cfg['num_epochs']),desc='Epochs'):
        ...
        with torch.inference_mode():
            ...
            for batch_idx, data in enumerate(val_dataloader):
                ...
                # print(f'Data: {data[0].shape}, {data[1].shape}, {data[2].shape}, {data[3].shape}')
                # print(f'Image: {data[0][0]}')
                # print(f'Action: {data[2][0]}')
                # print(f'Is pad: {data[3][0]}')
...
if __name__ == '__main__':
   ...
   # number of training episodes
    data_dir = os.path.join(task_cfg['dataset_dir'], '')
